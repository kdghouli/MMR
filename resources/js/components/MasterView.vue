            ...
            <ul v-for="camion in camionsMat" class="list-group" :key="camion">
                ...
                >
                    ...
                    <span
                        ...
                        v-if="camion.comment.length"
                        >{{ camion.comment.length }}</span
                    >
                </li>
            </ul>
        </div>
            ...
            >
                ...
                >
                    ...
                    <span
                        ...
                        v-if="voiture.comment.length"
                        >{{ voiture.comment.length }}</span
                    >
                </li>
            </ul>
        </div>
            ...
            >
                ...
                >
                    ...
                    ><span
                        ...
                        v-if="chariot.comment.length"
                        >{{ chariot.comment.length }}</span
                    >
                </li>
            </ul>
        </div>
            ...
            >
                ...
                >
                    ...
                    ><span
                        ...
                        v-if="scooter.comment.length"
                        >{{ scooter.comment.length }}</span
                    >
                </li>
            </ul>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8 mb-2">
                                    ...
                                    <select
                                        class="form-select fs-5"
                                        aria-label="Default select example"
                                        v-model="agenceCreato"
                                    >
                                        <option
                                            v-for="agenco in optionsTest"
                                            :key="agenco"
                                            :value="agenco"
                                        >
                                            {{ agenco }}
