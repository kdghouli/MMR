            ...
            >
                ...
                >
                    ...
                    <span class="badge bg-primary rounded-pill"
                        v-if="calcComments(voiture.id)"
                        >{{ calcComments(voiture.id) }}</span>
                </li>
            </ul>
        </div>
        <hr />
            ...
            >
                ...
                >
                    ...
                    ><span class="badge bg-warning rounded-pill"
                        v-if="calcComments(chariot.id)"
                        >{{ calcComments(chariot.id) }}</span>
                </li>
            </ul>
        </div>
        <hr />
            ...
            >
                ...
                >
                    ...
                    ><span class="badge bg-danger rounded-pill"
                        v-if="calcComments(scooter.id)"
                        >{{ calcComments(scooter.id) }}</span>
                </li>
            </ul>
        </div>
    </div>
...
export default {
    ...
    methods: {
        calcComments(ddd) {
            ...
            const nbComments = this.CommentsDb.filter(
                (sel) => sel.vhl_id == ddd
            );
